      ...
      <div class="listCont">
        ...
        <ul>
          <li v-for="(postsShow,index) in postsShow" v-if="index<6">
            ...
            <div>
              <h2>
                <a href="javascript:void(0);" @click="jumpToDetails({id:postsShow.id,labelId:postsShow.label_id,type:postsShow.type})">{{postsShow.title}}
              ...
              <ul>
                <li class="postsAvatar"><img :src="apiImg+head_image" alt="logo"><span>{{postsShow.author}}</span></li>
            ...
            <ul>
              <li><img src="../../../static/img/logo_product.png" alt="" v-show="postsShow.is_relevant_product_specialist==1" ></li>
              <li><img src="../../../static/img/logo_aut.png" alt="" v-show="postsShow.is_official_certification_specialist==1"></li>
  ...
  export default{
    ...
    methods: {
      ...
      jumpToDetails({
        ...
        that.$router.push({path:'newsDetail',query:{id:id,labelId:labelId,type:type}})
      },
      ...
      getArticleList({
        ...
        that.$http.get(that.$api+"/information/pageLabel",{
          ...
          console.log('%c 获取列表','color:green',list);
